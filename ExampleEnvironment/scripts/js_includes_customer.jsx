...
var USASOC_OnLogin = (function () {
    ...
    USASOC_OnLogin.gotXml = function (response) {
        console.log(JSON.stringify(response));
    };
    USASOC_OnLogin.gotError = function (req) {
        console.log(JSON.stringify(req));
    };
    addLoadEvent(function () {
        try {
            var ga = new GlideAjax('x_44813_usasoc_cst.UsasocUserNotificationManager');
            ga.addParam('sysparm_name', 'checkUserNotifications');
            ga.setErrorCallback(USASOC_OnLogin.gotError);
            ga.getXML(USASOC_OnLogin.gotXml);
        } catch (e) {
