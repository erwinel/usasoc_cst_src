...
var elems = {"window.FormDialog": "XY", "FormDialog": "XY", "body_FormDialog": "X", "dialog_frame": "X"};
for (var id in elems){
...
dragCell.ondragstart = function () { return false; };
return dragCell;
}
;
...
this.formDetails = {title: title, table: table, container: container, view: view, callback: this.refreshCallback, openCallback: openCallback};
},
